...
function sparseSnapshotTreeForget(sparseSnapshotTree, path) {
	if (pathIsEmpty(path)) {
		...
		if (sparseSnapshotTree.value.isLeafNode()) return false;
		else {
...
function treeForEachDescendant(tree, action, includeSelf, childrenFirst) {
	if (includeSelf && true) action(tree);
...
function repoManagerApplyEmulatorSettings(repo, hostAndPort, emulatorOptions, tokenProvider) {
	...
	repo.repoInfo_ = new RepoInfo(hostAndPort, isCloudWorkstation(host), repo.repoInfo_.namespace, repo.repoInfo_.webSocketOnly, repo.repoInfo_.nodeAdmin, repo.repoInfo_.persistenceKey, repo.repoInfo_.includeNamespaceInQueryParams, true, emulatorOptions);
